                            ...
                            <div class="panel-body">
								...
								<table id="lista-noticia" class="table dataTable table-hover">
									...
									<tbody>
                                        ...
                                        <?php foreach ($noticia as $noticia) { ?>
                                        <tr>
                                            <td><a href="#"><?= $noticia->id ?></td>
                                            <td class="titulo"><?= $noticia->titulo ?></td>
                                            <td><?= $noticia->texto ?></td>
                                            <td>
                                                <a href="/teste01/noticias/editar/<?= $noticia->id ?>"><span class="glyphicon glyphicon-pencil"></span></a>
                                                <a href="/teste01/noticias/excluir/<?= $noticia->id ?>"><span class="glyphicon glyphicon-remove-sign"></span></a>
                                            </td>
                                        </tr>
                                        <?php } ?>
